...
// TheSlotDef class is not a subclass of MonoBehaviour, so it doesn't need a
// separate C# file.
...
public class Layout : MonoBehaviour
{
    ...
    public string[] sortingLayerNames = new string[] { "Row0", "Row2", "Row3", "Discard", "Draw" };
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for (int i = 0; i < slotsX.Count; i++)
        {
            ...
            // effective at the same Z depth, so the layer is used
